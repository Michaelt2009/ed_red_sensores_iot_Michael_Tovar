/**
 * Experimentos de la Semana 3. Invocados desde IngestaSensores.
 */
public class BancoDePruebas {
    ...
    public static void experimentoUno() {
        ...
        for (int n : TAMANOS) {
            ...
            System.out.printf("%12d %16d %14.3f%n",
                    n, BuscadorLecturas.getComparaciones(), (fin - inicio) / 1_000_000.0);

            if (posicion < 0) {
                System.out.println("ADVERTENCIA: no encontró la lectura.");
            }
        }
        System.out.println();
    }
    ...
    public static void experimentoTres() {
        ...
        System.out.println("Lineal  (100k) -> comparaciones: " + lineal);
        System.out.println("Binaria (100k) -> comparaciones: " + binaria);
        System.out.println();
    }
